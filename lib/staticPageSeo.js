...
const STATIC_PAGE_SEO = {
  ...
  "/account-deletion": {
    title: "Account Deletion | UTSAVAS",
    description:
      "Request deletion of your UTSAVAS account and associated personal data through the official UTSAVAS account deletion page.",
  },
  "/security": {
